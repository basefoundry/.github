...
Use the repository's README and documentation first, then choose the least
...
- For documentation corrections, use the documentation form or a focused pull
  request.
- For a feature proposal, describe the user problem and desired outcome rather
  than prescribing an implementation.

If a repository disables or restricts issues, its README should point here or
to the canonical Discussions front door. Do not use public support channels for
credentials, personal data, or security-sensitive reports; use
